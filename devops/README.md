...
```
DEPLOY_ENV=prod
DEPLOY_HOST=plone-edu.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    plone-edu.example.com:
      ansible_user: root
      host: plone-edu
      hostname: plone-edu.example.com
```
...
Deploy the stack defined in `devops/stacks/plone-edu.example.com.yml` to the remote server with:
