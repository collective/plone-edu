"""Installer for the plone_edu package."""
...
setup(
    name="plone_edu",
    version="1.0.0a1",
    description="Plone EDU configuration package.",
    ...
    project_urls={
        "PyPI": "https://pypi.python.org/pypi/plone_edu",
    ...
    target = plone
    [console_scripts]
    update_locale = plone_edu.locales.update:update_locale
    """,
)
